...
// single node. The CLI adapter in tools/internal/toolcli owns the UI
...
// tools/internal/kairos/tools/flash/runner.go relates to tools/internal/toolcli/flash.go:
