...
The overlay does not enable the K3s service; node provisioning writes the role
activation cloud-config after role-specific config and bootstrap manifests are
in place.
