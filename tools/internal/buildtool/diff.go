...
func DiffManifests(ctx context.Context, opts DiffManifestsOptions) error {
	...
	wf.Task("Diff deploy manifests", func(execCtx context.Context) error {
		return diffManifests(execCtx, opts.RepoRoot, opts.RemoteURL)
	})
	return wf.Execute(ctx)
}

func diffManifests(ctx context.Context, repoRoot string, remoteURL string) error {
