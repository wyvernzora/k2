...
func (c *bootstrapCmd) Run(rcx *Runtime) error {
	return runBootstrapProvision(context.Background(), rcx, c)
}

func runBootstrapProvision(parent context.Context, rcx *Runtime, c *bootstrapCmd) error {
...
func (c *bootstrapCmd) buildBootstrapWorkflow(wf *ui.Workflow, rcx *Runtime, s *bootstrapState) {
...
func (c *bootstrapCmd) stepRenderBundle(rcx *Runtime, s *bootstrapState) func(context.Context) error {
...
func (c *bootstrapCmd) stepHarvest(rcx *Runtime, s *bootstrapState) func(context.Context, ui.Step) error {
	return func(ctx context.Context, sh ui.Step) error {
		defer s.client.SwapIO(sh)()
...
func (c *bootstrapCmd) prepareTestVM(ctx *Runtime) (testVMProvisionTarget, error) {
