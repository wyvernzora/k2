...
func (r Runner) addRpi4cbPrelude(wf *ui.Workflow, st *rpi4cbState) {
	wf.Step("resolve-target", func(ctx context.Context) error {
		var err error
	...
	wf.Step("resolve-platform", func(ctx context.Context) error {
		var err error
...
func (r Runner) addRpi4cbDiskResolution(wf *ui.Workflow, st *rpi4cbState, opts Rpi4cbOptions) {
	...
	wf.Step("resolve-explicit-disks", func(ctx context.Context) error {
		return resolveExplicitDisks(ctx, st, opts)
	}).Unless(autoDetect)

	wf.Section("rpiboot").Unless(explicit)

	wf.Step("snapshot-disks", func(ctx context.Context) error {
		var err error
